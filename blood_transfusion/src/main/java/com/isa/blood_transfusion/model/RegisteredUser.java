...
public class RegisteredUser extends AppUser {
    ...
    public RegisteredUser(Long id, String email, String password, String name, String surname, String phoneNum, String identityNumber, String profession, String facilityInfo, Role role, Address address, Gender gender, Integer points, Integer numOfPenalties, UserCategory userCategory, Set<Center> visitedCenters, Set<ScheduledAppointment> scheduledAppointments, Set<PerformedAppointment> performedAppointments) {
