...
public class SystemAdministratorEntity extends AppUserEntity {
    ...
    public SystemAdministratorEntity(Long id, String email, String password, String name, String surname, String phoneNum, String identityNumber, String profession, String facilityInfo, RoleEntity role, AddressEntity address, Gender gender) {
